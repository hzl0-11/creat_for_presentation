...
-- 用户自定义
require("whtDefParam")
require("whtDefFunction")
require("whtDefTask")

require("whtAttackParam")
require("whtAttackFunction")
require("whtAttackTask")

require("whtCommonParam")
require("whtCommonFunction")
require("whtCommonTask")
